...
public class CondicionesCompetencia extends javax.swing.JInternalFrame {

    public CondicionesCompetencia() {
        initComponents();
        rc = new RcCC();
        
        h1 = new HiloCC(Area1, rc);
        h1.setName("Perrito 1");
        
        h2 = new HiloCC(Area2, rc);
        h2.setName("Perrito 2");
        
        h3 = new HiloCC(Area3, rc);
        h3.setName("Perrito 3");
        
        h4 = new HiloCC(Area4, rc);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Condiciones Competencia");
