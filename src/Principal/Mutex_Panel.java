...
public class Mutex_Panel extends javax.swing.JInternalFrame {

    public Mutex_Panel() {
        initComponents();
        rc = new RcCC();
        
        h1 = new Mutex_Brain(Area1, rc);
        h1.setName("Perrito 1");
        
        h2 = new Mutex_Brain(Area2, rc);
        h2.setName("Perrito 2");
        
        h3 = new Mutex_Brain(Area3, rc);
        h3.setName("Perrito 3");
        
        h4 = new Mutex_Brain(Area4, rc);
