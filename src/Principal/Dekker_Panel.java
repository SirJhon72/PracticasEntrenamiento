...
public class Dekker_Panel extends javax.swing.JInternalFrame {

 
    public Dekker_Panel() {
        initComponents();
        rc = new RcCC();
        h1 = new Dekker_Brain(0, Area1, rc, 0, "perrito 1");
        h1.setName("Perrito 1");
        
        h2 = new Dekker_Brain(1, Area2, rc, 1, "perrito 2");
        h2.setName("Perrito 2");
        
        h3 = new Dekker_Brain(0, Area3, rc, 0, "perrito 3");
        h3.setName("perrito 3");
        
        h4 = new Dekker_Brain(1, Area4, rc, 1, "perrito 4");
